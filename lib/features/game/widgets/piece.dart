...
class _PieceState extends State<Piece> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    _animationController = AnimationController(
      lowerBound: AppDurations.animationLowerBound,
      upperBound: AppDurations.animationUpperBound,
      duration: const Duration(milliseconds: AppDurations.pieceAnimation),
      vsync: this,
    );
